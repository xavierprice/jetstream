      ...
      <main className="home-page">
          ...
          <div className="main-container">
            <div className="heading-section-left">
              <section className="heading-introduction">
                ...
                <p>
                  Enhance your property's curb appeal and cleanliness
                  effortlessly with our top-tier pressure washing services. From
                  driveways to exteriors, we restore the shine to your surfaces,
                  making your property look brand new.
                </p>
              </section>
            </div>
        ...
        <section className="services-section">
          <div className="service-container">
            ...
            <p>
              Revitalize your space with our top-notch pressure washing
              services, specializing in removing stains and restoring the beauty
              of your property. Elevate your curb appeal with Jetstream – your
              go-to for professional pressure washing solutions!
            </p>
              ...
              <div className="text">
                <div className="introduction">
                  ...
                  <p>
                    ...
                    refreshing home exteriors, we take pride in bringing back
                    the shine to your spaces. Our goal is simple: to exceed your
        ...
        <section className="steps-section">
          <div className="main-container">
            <h1>How we work</h1>
            <p>
              Take a look at how we run things here at Jetstream pressure
              washing.
            </p>
        ...
        <section className="work-preview-section">
          ...
          <div className="main-container">
            ...
            <p>
              Hover over any one of the videos to see us restoring properties
              all over Brisbane!
            </p>
